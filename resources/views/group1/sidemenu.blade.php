    ...
    <div class="panel-body">
        <ul class="list-group list-unstyled">
            ...
            <li><a href="#collapseOne" class="list-group-item" data-toggle="collapse">งานศูนย์ข้อมูลและสารสนเทศ</a>
               <ul id="collapseOne" class="collapse in"> <li><a class="list-group-item" href={{route('students.index')}}>ข้อมูลนักเรียน</a></li></ul></li>
            ...
            <a href="#" class="list-group-item">งานความร่วมมือ</a>
        </ul>
    </div>
</div>
