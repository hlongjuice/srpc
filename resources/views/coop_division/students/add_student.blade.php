    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 col-md-6 form-group">
                {{Form::label('student_id','รหัสนักเรียน')}}
                {{Form::text('student_id',null,array('class'=>'form-control','placeholder'=>'xxxxxxxxx'))}}
            </div>

            {{--Faculty--}}
            <div class="col-xs-12 col-md-6 form-group">
                {{Form::label('faculty','คณะ')}}
                {{Form::text('faculty',null,array('class'=>'form-control','placeholder'=>'ชื่อคณะ'))}}
            </div>
            {{--Gender--}}
